...
Order: 1 → 2 → 3 → 4, then the flip in the distribution — the hand-written flow retires and its template replaces it, the strangler's first bite, and the funding pitch's sentence made true.
