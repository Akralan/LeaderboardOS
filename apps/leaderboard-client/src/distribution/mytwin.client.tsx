...
const SLOTS: Readonly<Record<string, FlowUiSlots>> = {
  ...
  // Le template journey-validation garde ses écrans de scénario écrits à la main, sur ses routes ;
  // son bloc `ui` compose les mêmes écrans (catalogue) pour une copie du template en base.
